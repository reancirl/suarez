        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('zone.update',$data->id) }}">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="w-1/2 px-3 mb-6 md:mb-0">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <x-select class="w-full" name="leader" id="leader">
                                        ...
                                        @if($data->leader)
                                            <option value="{{ $data->leader->id }}" selected>{{ $data->leader->name }}</option>
                                        @endif
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3 mb-6 md:mb-0">
                                ...
                                <x-input id="note" class="mt-1 w-full" type="text" name="note" :value="$data->note" autofocus />
                            </div>
                        </div>
